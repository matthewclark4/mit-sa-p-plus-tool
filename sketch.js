...
const WALL_TYPES = {
    ...
    image: {
        ...
        unitSize: 286, unitCount: 2, spreadX: 170, spreadY: 70, spreadZ: [-40, 90],
        tiltXRange: 0.10, tiltYRange: 0.18, rotRange: 0.35,
    },
};
...
const PAGES = [
    ...
    { id: 'block-newsletter', type: 'block', nav: 'Block: Newsletter', zoom: 1.794, unitCount: 3,
      faceImage: WORDMARK_SVG,
      sectionBg: '#707F00', wallBg: '#E0FD65', wallInk: '#707F00' },
    { id: 'block-donate', type: 'block', nav: 'Block: Donate', zoom: 1.8837, unitCount: 3,
      faceImage: SVG_DIR + 'donate.svg',
      sectionBg: '#6B0033', wallBg: '#E0FD65', wallInk: '#6B0033' },
    { id: 'block-arc', type: 'block', nav: 'Block: ARC', zoom: 1.5209, unitCount: 3,
      faceImage: SVG_DIR + 'Block – Architecture.svg',
      sectionBg: '#EEB1FF', wallBg: '#000000', wallInk: '#EEB1FF' },
    { id: 'block-cre', type: 'block', nav: 'Block: CRE', zoom: 2.392, unitCount: 3,
      faceImage: SVG_DIR + 'Block – CRE.svg',
      sectionBg: '#FD6234', wallBg: '#ffffff', wallInk: '#FD6234' },
    { id: 'block-lcau', type: 'block', nav: 'Block: LCAU', zoom: 2.2483, unitCount: 3,
      faceImage: SVG_DIR + 'Block – LCAU.svg',
      sectionBg: '#9AB1FF', wallBg: '#000000', wallInk: '#9AB1FF' },
    { id: 'block-mad', type: 'block', nav: 'Block: MAD', zoom: 2.392, unitCount: 3, spreadMult: 1.3,
      faceImage: SVG_DIR + 'MAD.svg',
      sectionBg: '#FFC486', wallBg: '#000000', wallInk: '#FFC486' },
    { id: 'block-medialab', type: 'block', nav: 'Block: Media Lab', zoom: 1.764, unitCount: 3,
      faceImage: SVG_DIR + 'Block – Media Lab.svg',
      sectionBg: '#6B0033', wallBg: '#ffffff', wallInk: '#6B0033' },
    { id: 'block-dusp', type: 'block', nav: 'Block: DUSP', zoom: 2.52, unitCount: 2,
